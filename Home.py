...
st.markdown("""
    ...
    Investment prioritization is a challenge as Tanzania’s water management system employs a decentralized structure, creating disparate information regarding administrative water basins and the regions subsumed in each of these administrative constructs. 
    The Capstone Project intends to unify information on the water basins, to facilitate the identification of areas or communities under climate stress for investment prioritization. 
    """)

st.info("Click on the left sidebar menu to navigate to the vulnerability clustering app and the exploratory dashboard.")
